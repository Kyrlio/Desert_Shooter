...
"uid://64sjetxrpab7", "uid://pq8pimrg2nfh", "uid://blq81prqmljm0", "uid://pklrei6nqtbh", "uid://bb26mekndveyd"]
...
func next_round() -> PackedScene:
	...
	if multiplayer_actual_scene == multiplayer_next_scene:
		multiplayer_next_scene = levels.pick_random()
	levels.erase(multiplayer_next_scene)
	return load(multiplayer_next_scene)


func get_end_game_scene() -> PackedScene:
	return load("res://scenes/end_game/final_scores.tscn")
